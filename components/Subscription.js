...
const Subscription = () => {
    return (
        <div className='mx-20 mt-32 mx-auto' style={{ backgroundImage: `url(https://i.ibb.co/QQYP6fr/girl.png)`, backgroundRepeat: 'no-repeat', height: '400px', backgroundPosition: "cover" }}>
           <div className='pl-12 pt-[5rem] flex flex-col justify-center '>
