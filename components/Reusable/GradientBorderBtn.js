...
const GradientBorderBtn = ({btnText}) => {
    console.log(btnText)
    return (
        <button class='w-[135px] h-[40px] bg-[#1E1E1E] rounded-md text-white font-normal text-[16px] relative
        ...
        before:rounded-md hover:bg-[#B843B7] transition-all duration-300 px-[10px]
    '>
        {btnText}
    </button>
